...
This pair of cpp and h file provides a very easy way to draw text in OpenGL.
...
textBaker contains few details about this.

 For now, I got a bit acky, here: baking Fonts is aschieved with patching GLText 0.3.1 ( http://gltext.sourceforge.net/home.php )
